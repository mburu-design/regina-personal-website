...
export default function Header({ currentPage = 'home', onNavigate }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full px-6 py-4 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 backdrop-blur-md bg-opacity-95 z-50 shadow-lg">
      <nav className="flex items-center justify-between max-w-6xl mx-auto">
        ...
        <div className="flex items-center space-x-4">
          {/* YouTube */}
          <a
            href="https://youtube.com/@drreginakingoricpak?si=QsjKR8gui2zVHyYD"
            target="_blank"
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/regina-kingori/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* Newsletter/Blog */}
          <a
            href="https://www.linkedin.com/build-relation/newsletter-follow?entityUrn=7069596794241921024"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* Instagram */}
          <a
            href="https://instagram.com/regina.kingori"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* TikTok */}
          <a
            href="https://tiktok.com/@regina_kingori"
            target="_blank"
            rel="noopener noreferrer"
